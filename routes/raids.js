...
router.get('/:id/registrations', (ctx, next) => Auth.authenticate(ctx, next, ['member', 'casu', 'guest']), Raids.getRegistrations)
router.get('/:id/registration-logs', (ctx, next) => Auth.authenticate(ctx, next, ['member', 'casu', 'guest']), Raids.getRegistrationLogs)
router.get('/:id', (ctx, next) => Auth.authenticate(ctx, next, ['member', 'casu', 'guest']), Raids.getRaid)
...
router.post('/registration', (ctx, next) => Auth.authenticate(ctx, next, ['member', 'casu', 'guest']), Raids.createRegistration)
...
router.get('/:id/missing-registrations', (ctx, next) => Auth.authenticate(ctx, next, ['member', 'casu', 'guest']), Raids.missingRegistrations)
