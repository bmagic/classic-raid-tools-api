...
router.get('/:id/registrations', (ctx, next) => Auth.authenticate(ctx, next, ['member', 'guest']), Raids.getRegistrations)
router.get('/:id/registration-logs', (ctx, next) => Auth.authenticate(ctx, next, ['member', 'guest']), Raids.getRegistrationLogs)
router.get('/:id', (ctx, next) => Auth.authenticate(ctx, next, ['member', 'guest']), Raids.getRaid)
